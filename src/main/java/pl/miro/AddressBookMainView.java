...
import pl.miro.PersonEditor.EditorSavedEvent;
import pl.miro.PersonEditor.EditorSavedListener;
import pl.miro.domain.Person;
...
public class AddressBookMainView extends HorizontalSplitPanel implements ComponentContainer {
	...
	private static final long serialVersionUID = 2825015819494983895L;
    ...
    public AddressBookMainView() {
        ...
        persons = JPAContainerFactory.make(Person.class, Faktura.PERSISTENCE_UNIT);
       // buildTree();
        buildMainArea();
    ...
    private void buildMainArea() {
        ...
        personTable.setVisibleColumns(new Object[] { "firstName", "lastName", "phoneNumber", "street", "city", "zipCode" });
